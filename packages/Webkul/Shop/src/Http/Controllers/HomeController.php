...
class HomeController extends Controller
{
     ...
     * @return void
     */
    public function __construct(protected ThemeCustomizationRepository $themeCustomizationRepository, protected CategoryRepository $categoryRepository, ProductRepository $productRepository)
    {
    ...
    $products = ProductFlat::where('status', 1)
        ...
        return view('shop::home.index', compact('customizations', 'categories', 'products'));
    }
